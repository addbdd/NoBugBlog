		...
		<div class="ui container">
			...
			<el-dropdown trigger="click" @command="categoryRoute">
				...
				<el-dropdown-menu slot="dropdown">
					<el-dropdown-item command="学习笔记">学习笔记</el-dropdown-item>
    				<el-dropdown-item command="个人项目">个人项目</el-dropdown-item>
    				<el-dropdown-item command="技术杂烩">技术杂烩</el-dropdown-item>
    				<el-dropdown-item command="心情随写">心情随写</el-dropdown-item>
