...
public class BlogAdminController {
	...
	@PostMapping("/blog")
	public Result saveBlog(@RequestBody top.nobug.model.dto.Blog blog) {
	...
	@PutMapping("/blog")
	public Result updateBlog(@RequestBody top.nobug.model.dto.Blog blog) {
	 ...
	 * @return
	 */
	private Result getResult(top.nobug.model.dto.Blog blog, String type) {
		//验证普通字段
