package top.nobug.util.comment;
...
import top.nobug.constant.PageConstants;
...
import top.nobug.util.HashUtils;
import top.nobug.util.IpAddressUtils;
import top.nobug.util.MailUtils;
import top.nobug.util.QQInfoUtils;
import top.nobug.util.StringUtils;
import top.nobug.util.comment.channel.ChannelFactory;
import top.nobug.util.comment.channel.CommentNotifyChannel;
import top.nobug.enums.CommentOpenStateEnum;
import top.nobug.enums.CommentPageEnum;
...
public class CommentUtils {
	 ...
	 */
	public void judgeSendNotify(Comment comment, boolean isVisitorComment, top.nobug.entity.Comment parentComment) {
	 ...
	 * @param comment       当前收到的评论
	 */
	private void sendMailToParentComment(top.nobug.entity.Comment parentComment, Comment comment) {
