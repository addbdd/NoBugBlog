...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		top.nobug.entity.ScheduleJob scheduleJob = (top.nobug.entity.ScheduleJob) context.getMergedJobDataMap().get(top.nobug.entity.ScheduleJob.JOB_PARAM_KEY);
		//获取spring bean
