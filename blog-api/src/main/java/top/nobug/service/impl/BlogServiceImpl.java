...
import top.nobug.exception.NotFoundException;
import top.nobug.exception.PersistenceException;
import top.nobug.mapper.BlogMapper;
...
public class BlogServiceImpl implements BlogService {
	...
	@Transactional(rollbackFor = Exception.class)
	@Override
	public void saveBlog(top.nobug.model.dto.Blog blog) {
	...
	@Transactional(rollbackFor = Exception.class)
	@Override
	public void updateBlog(top.nobug.model.dto.Blog blog) {
